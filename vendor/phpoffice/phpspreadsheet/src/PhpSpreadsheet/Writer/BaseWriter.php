...
abstract class BaseWriter implements IWriter
{
	...
	//プログラムID
	protected $programId = "";
	public function setProgramId($pValue)
	{
...
/* 	//X軸データソース
	protected $aXDataSource = [];
	public function setXDataSource($pArr)
	{
		$this->aXDataSource = $pArr;

		return $this;
	}
    public function getXDataSource($piArr)
    {
        return $this->aXDataSource[$piArr];
    } */
	
	protected $iSer = 0;
    public function getSerCnt()
    {
		$iCnt = $this->iSer;
		$this->iSer = $iCnt + 1;
        return $iCnt;
