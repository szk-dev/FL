...
<center>
<form name="form" method="post" action="loginCheck.php" autocomplete="off">
	...
	<TABLE borderColor="#999999" cellSpacing="0" cellPadding="0" rules="all" border="2">
		...
		<!--
		<TR>
			<TD colSpan="2"><IMG alt="株式会社鈴木" src="img/logo/copyright.gif" border="0"></TD>
		</TR>
		-->
	</TABLE>
