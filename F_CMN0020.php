...
<center>
<form name="form" method="post" action="loginCheck.php?page=<?php echo $strPage ?>&rrcno=<?php echo $strRrcno ?>&rrcseq=<?php echo $strRrcseq ?>" autocomplete="off">
